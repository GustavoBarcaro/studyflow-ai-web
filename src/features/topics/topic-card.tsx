...
export function TopicCard({ topic, sessionsCount, lastActivity, onDelete, isDeleting = false }: TopicCardProps) {
      ...
      <CardContent className="space-y-4 pt-6">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">{sessionsCount} study sessions</p>
          </div>
